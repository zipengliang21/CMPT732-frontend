...
const createCustomShadow = color => {
  ...
  return {
    ...
    primary: `0 2px 4px 0 ${alpha(palette.primary.main, 0.24)}`,
    secondary: `0 2px 4px 0 ${alpha(palette.secondary.main, 0.24)}`,
    info: `0 2px 4px 0 ${alpha(palette.info.main, 0.24)}`,
    success: `0 2px 4px 0 ${alpha(palette.success.main, 0.24)}`,
    warning: `0 2px 4px 0 ${alpha(palette.warning.main, 0.24)}`,
    error: `0 2px 4px 0 ${alpha(palette.error.main, 0.24)}`
  };
};
